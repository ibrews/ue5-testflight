...
install_agent "macosbuild"    "run_macos_build.sh"     "macos-build"
install_agent "shipmacos"     "ship_macos.sh"          "ship-macos"
...
echo "  macOS:    launchctl start $ORG_LABEL.macosbuild"
echo ""
echo "Monitor:"
...
echo "  tail -f /tmp/ue5kit-macos-build.log"
echo "  tail -f /tmp/ue5kit-ship-macos.log"
echo ""
...
echo "  /opt/homebrew/bin/python3 $SCRIPT_DIR/scripts/attach_to_group.py macos"
